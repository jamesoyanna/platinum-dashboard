                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <h5 className="font-size-14 mb-0">Lagos</h5>
                            </td>
                            <td>
                              <div id="spak-chart1"></div>
                            </td>
                            <td>
                              <p className="text-muted mb-0">₦ 54100</p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <p className="text-muted mb-0">₦ 22400</p>
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                              <h5 className="font-size-14 mb-0">Abuja</h5>
                            </td>
                            <td>
                              <div id="spak-chart3"></div>
                            </td>
                            <td>
                              <p className="text-muted mb-0">₦ 23500</p>
                            </td>
                          </tr>
                        </tbody>
                      </Table>
